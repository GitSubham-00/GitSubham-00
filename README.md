...
#### Hello, I'm Subham! I work with data to find important information. I use computer programing language like Python and SQL to help me. With these tools, I can make data easier to understand. I also use PowerBI to create charts and graphs. These show the data in a visual way. I enjoy to solve puzzles!
